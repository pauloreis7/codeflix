...
public class ListCategoriesTest
{
  ...
  {
    CodeflixCatalogDbContext dbContext = ListCategoriesTestFixture.CreateDbContext();
  ...
  )
  {
    ...
    var expectedOrderedList = ListCategoriesTestFixture.CloneCategoriesListOrdered(
